...
class GraphFrame(wx.Frame):
    ...
    def __init__(self):
        ...
        self.redraw_timer.Start(300) #originally 40
        self.data_timer.Start(220)    #originally 20
    ...
    def init_plot(self):
        ...
        self.axes.set_title('Oscilloscope', size=8)
    ...
    def on_data_timer(self, event):
        ...
        if not self.paused:
            try:
                ...
                self.volts.SetLabel( '%04.2F' % round(floatvolts,3)+"dB SPL")
                heDevice.write(ord("1"))
            except:
                pass
